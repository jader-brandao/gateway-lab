...
<head>
    ...
    <title><?php echo e(config('getfy.app_name', config('app.name', 'gatewayLab'))); ?></title>
    <?php if (! ($skipPanelPwa)): ?>
    <?php
    ...
    <?php elseif(is_file(public_path('icons/icone.png'))): ?>
    <link rel="apple-touch-icon" href="<?php echo e($wlWithVersion(url('/icons/icone.png'))); ?>">
...
<?php /**PATH C:\laragon\www\gateway-lab\resources\views/app.blade.php ENDPATH**/ ?>