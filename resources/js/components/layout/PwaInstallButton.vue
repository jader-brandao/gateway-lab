...
const pwaPluginEnabled = computed(() => isPluginEnabled('pwa'));
const {
...
const showInstallButton = computed(() => pwaPluginEnabled.value && canShowInstallButton.value);
...
<template>
    <div v-if="showInstallButton" class="space-y-1">
        <button
            type="button"
