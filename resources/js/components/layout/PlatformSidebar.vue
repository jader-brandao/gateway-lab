...
const appName = () => appSettings().app_name || 'gatewayLab';
...
const navItems = [
    ...
    { name: 'Minha conta', href: '/plataforma/conta', icon: KeyRound },
...
/** Sidebar um tom mais claro que a área principal (zinc-50 / zinc-800) */
const linkInactive =
...
<template>
    <aside
        class="fixed inset-y-0 left-0 z-[99999] flex h-screen w-[260px] flex-col border-r border-zinc-200/80 bg-zinc-50 transition-all duration-300 ease-in-out dark:border-zinc-700/50 dark:bg-zinc-800"
        :class="[
            {
