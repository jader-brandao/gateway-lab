        ...
        >
            ...
            >
                ...
                <div v-if="!product.login_without_password">
                    <div class="mb-1.5 flex items-center justify-between">
                        ...
                        <a
                            ...
                            :style="{ color: product.primary_color || '#8A2BE2' }"
                        >
                            Esqueci minha senha
                        </a>
                    </div>
                ...
                <button
                    ...
                    :style="{ backgroundColor: product.primary_color || '#8A2BE2' }"
