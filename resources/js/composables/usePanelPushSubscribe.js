...
export function usePanelPushSubscribe() {
    const page = usePage();
    const pluginEnabled = computed(() => page.props.pwa_plugin_enabled !== false);
    ...
    async function registerAndSubscribe() {
        ...
        if (!pluginEnabled.value) {
            lastPushError.value = 'pwa_plugin_disabled';
            return false;
        }
