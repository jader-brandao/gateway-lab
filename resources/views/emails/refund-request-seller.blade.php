...
<body style="font-family: system-ui, sans-serif; line-height: 1.5; color: #18181b;">
    ...
    <p><a href="{{ $manageUrl }}" style="display:inline-block;margin-top:12px;padding:12px 20px;background:#8A2BE2;color:#fff;text-decoration:none;border-radius:8px;">Ver solicitações</a></p>
